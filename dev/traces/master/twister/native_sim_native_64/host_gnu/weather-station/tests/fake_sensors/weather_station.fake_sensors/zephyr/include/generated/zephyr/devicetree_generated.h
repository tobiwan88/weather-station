 ...
 *
 * DTS input file:
 *   /__w/weather-station/weather-station/twister-out/native_sim_native_64/host_gnu/weather-station/tests/fake_sensors/weather_station.fake_sensors/zephyr/zephyr.dts.pre
 *
...
/*
 * Devicetree node: /fake-hum-test
 *
 * Node identifier: DT_N_S_fake_hum_test
 *
...
/* Node's full path: */
#define DT_N_S_fake_hum_test_PATH "/fake-hum-test"

/* Node's name with unit-address: */
#define DT_N_S_fake_hum_test_FULL_NAME "fake-hum-test"
#define DT_N_S_fake_hum_test_FULL_NAME_UNQUOTED fake-hum-test
#define DT_N_S_fake_hum_test_FULL_NAME_TOKEN fake_hum_test
#define DT_N_S_fake_hum_test_FULL_NAME_UPPER_TOKEN FAKE_HUM_TEST

/* Node parent (/) identifier: */
#define DT_N_S_fake_hum_test_PARENT DT_N

/* Node's index in its parent's list of children: */
#define DT_N_S_fake_hum_test_CHILD_IDX 27

/* Helpers for dealing with node labels: */
#define DT_N_S_fake_hum_test_NODELABEL_NUM 1
#define DT_N_S_fake_hum_test_FOREACH_NODELABEL(fn) fn(fake_hum_test)
#define DT_N_S_fake_hum_test_FOREACH_NODELABEL_VARGS(fn, ...) fn(fake_hum_test, __VA_ARGS__)
#define DT_N_S_fake_hum_test_FOREACH_ANCESTOR(fn) fn(DT_N)

/* Helper macros for child nodes of this node. */
#define DT_N_S_fake_hum_test_CHILD_NUM 0
#define DT_N_S_fake_hum_test_CHILD_NUM_STATUS_OKAY 0
#define DT_N_S_fake_hum_test_FOREACH_CHILD(fn) 
#define DT_N_S_fake_hum_test_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_fake_hum_test_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_fake_hum_test_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_fake_hum_test_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_fake_hum_test_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_fake_hum_test_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_fake_hum_test_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's hash: */
#define DT_N_S_fake_hum_test_HASH bErew1QBU1f__JtvkXlQXLa_kvPeLoiCR_Fx2eryOMs

/* Node's dependency ordinal: */
#define DT_N_S_fake_hum_test_ORD 11
#define DT_N_S_fake_hum_test_ORD_STR_SORTABLE 00011

/* Ordinals for what this node depends on directly: */
#define DT_N_S_fake_hum_test_REQUIRES_ORDS \
	0, /* / */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_fake_hum_test_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_fake_hum_test_EXISTS 1
#define DT_N_INST_0_fake_humidity    DT_N_S_fake_hum_test
#define DT_N_NODELABEL_fake_hum_test DT_N_S_fake_hum_test

/* Macros for properties that are special in the specification: */
#define DT_N_S_fake_hum_test_REG_NUM 0
#define DT_N_S_fake_hum_test_FOREACH_REG(fn) 
#define DT_N_S_fake_hum_test_FOREACH_REG_SEP(fn, sep) 
#define DT_N_S_fake_hum_test_FOREACH_REG_VARGS(fn, ...) 
#define DT_N_S_fake_hum_test_FOREACH_REG_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_fake_hum_test_RANGES_NUM 0
#define DT_N_S_fake_hum_test_FOREACH_RANGE(fn) 
#define DT_N_S_fake_hum_test_IRQ_NUM 0
#define DT_N_S_fake_hum_test_IRQ_LEVEL 0
#define DT_N_S_fake_hum_test_COMPAT_MATCHES_fake_humidity 1
#define DT_N_S_fake_hum_test_COMPAT_VENDOR_IDX_0_EXISTS 1
#define DT_N_S_fake_hum_test_COMPAT_VENDOR_IDX_0 "Fake sensors (simulation and testing only)"
#define DT_N_S_fake_hum_test_COMPAT_MODEL_IDX_0_EXISTS 1
#define DT_N_S_fake_hum_test_COMPAT_MODEL_IDX_0 "humidity"
#define DT_N_S_fake_hum_test_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_fake_hum_test_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_fake_hum_test_P_initial_value_mpct 45000
#define DT_N_S_fake_hum_test_P_initial_value_mpct_EXISTS 1

/*
 * Devicetree node: /fake-temp-test
 *
 * Node identifier: DT_N_S_fake_temp_test
 *
...
/* Node's full path: */
#define DT_N_S_fake_temp_test_PATH "/fake-temp-test"

/* Node's name with unit-address: */
#define DT_N_S_fake_temp_test_FULL_NAME "fake-temp-test"
#define DT_N_S_fake_temp_test_FULL_NAME_UNQUOTED fake-temp-test
#define DT_N_S_fake_temp_test_FULL_NAME_TOKEN fake_temp_test
#define DT_N_S_fake_temp_test_FULL_NAME_UPPER_TOKEN FAKE_TEMP_TEST

/* Node parent (/) identifier: */
#define DT_N_S_fake_temp_test_PARENT DT_N

/* Node's index in its parent's list of children: */
#define DT_N_S_fake_temp_test_CHILD_IDX 26

/* Helpers for dealing with node labels: */
#define DT_N_S_fake_temp_test_NODELABEL_NUM 1
#define DT_N_S_fake_temp_test_FOREACH_NODELABEL(fn) fn(fake_temp_test)
#define DT_N_S_fake_temp_test_FOREACH_NODELABEL_VARGS(fn, ...) fn(fake_temp_test, __VA_ARGS__)
#define DT_N_S_fake_temp_test_FOREACH_ANCESTOR(fn) fn(DT_N)

/* Helper macros for child nodes of this node. */
#define DT_N_S_fake_temp_test_CHILD_NUM 0
#define DT_N_S_fake_temp_test_CHILD_NUM_STATUS_OKAY 0
#define DT_N_S_fake_temp_test_FOREACH_CHILD(fn) 
#define DT_N_S_fake_temp_test_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_fake_temp_test_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_fake_temp_test_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_fake_temp_test_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_fake_temp_test_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_fake_temp_test_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_fake_temp_test_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's hash: */
#define DT_N_S_fake_temp_test_HASH bmX5Xq48S6qiNXFue_hgDsYLbeUPJh34XvHZ_4Lty7s

/* Node's dependency ordinal: */
#define DT_N_S_fake_temp_test_ORD 12
#define DT_N_S_fake_temp_test_ORD_STR_SORTABLE 00012

/* Ordinals for what this node depends on directly: */
#define DT_N_S_fake_temp_test_REQUIRES_ORDS \
	0, /* / */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_fake_temp_test_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_fake_temp_test_EXISTS 1
#define DT_N_INST_0_fake_temperature  DT_N_S_fake_temp_test
#define DT_N_NODELABEL_fake_temp_test DT_N_S_fake_temp_test

/* Macros for properties that are special in the specification: */
#define DT_N_S_fake_temp_test_REG_NUM 0
#define DT_N_S_fake_temp_test_FOREACH_REG(fn) 
#define DT_N_S_fake_temp_test_FOREACH_REG_SEP(fn, sep) 
#define DT_N_S_fake_temp_test_FOREACH_REG_VARGS(fn, ...) 
#define DT_N_S_fake_temp_test_FOREACH_REG_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_fake_temp_test_RANGES_NUM 0
#define DT_N_S_fake_temp_test_FOREACH_RANGE(fn) 
#define DT_N_S_fake_temp_test_IRQ_NUM 0
#define DT_N_S_fake_temp_test_IRQ_LEVEL 0
#define DT_N_S_fake_temp_test_COMPAT_MATCHES_fake_temperature 1
#define DT_N_S_fake_temp_test_COMPAT_VENDOR_IDX_0_EXISTS 1
#define DT_N_S_fake_temp_test_COMPAT_VENDOR_IDX_0 "Fake sensors (simulation and testing only)"
#define DT_N_S_fake_temp_test_COMPAT_MODEL_IDX_0_EXISTS 1
#define DT_N_S_fake_temp_test_COMPAT_MODEL_IDX_0 "temperature"
#define DT_N_S_fake_temp_test_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_fake_temp_test_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_fake_temp_test_P_initial_value_mdegc 22000
#define DT_N_S_fake_temp_test_P_initial_value_mdegc_EXISTS 1
...
#define DT_FOREACH_OKAY_fake_temperature(fn) fn(DT_N_S_fake_temp_test)
#define DT_FOREACH_OKAY_VARGS_fake_temperature(fn, ...) fn(DT_N_S_fake_temp_test, __VA_ARGS__)
...
#define DT_FOREACH_OKAY_fake_humidity(fn) fn(DT_N_S_fake_hum_test)
#define DT_FOREACH_OKAY_VARGS_fake_humidity(fn, ...) fn(DT_N_S_fake_hum_test, __VA_ARGS__)
