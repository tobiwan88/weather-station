...
biometric_driver_api_area : { _biometric_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._biometric_driver_api.static.*))); _biometric_driver_api_list_end = .;; }
...
otp_driver_api_area : { _otp_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._otp_driver_api.static.*))); _otp_driver_api_list_end = .;; }
...
uaol_driver_api_area : { _uaol_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._uaol_driver_api.static.*))); _uaol_driver_api_list_end = .;; }
...
wuc_driver_api_area : { _wuc_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._wuc_driver_api.static.*))); _wuc_driver_api_list_end = .;; }
...
stepper_ctrl_driver_api_area : { _stepper_ctrl_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._stepper_ctrl_driver_api.static.*))); _stepper_ctrl_driver_api_list_end = .;; }
...
ztest :
{
 ...
 net_l3_register_area : { _net_l3_register_list_start = .; KEEP(*(SORT_BY_NAME(._net_l3_register.static.*))); _net_l3_register_list_end = .;; }
 net_socket_register_area : { _net_socket_register_list_start = .; KEEP(*(SORT_BY_NAME(._net_socket_register.static.*))); _net_socket_register_list_end = .;; }
 http_service_desc_area : { _http_service_desc_list_start = .; KEEP(*(SORT_BY_NAME(._http_service_desc.static.*))); _http_service_desc_list_end = .;; }
 net_socket_service_desc_area : { _net_socket_service_desc_list_start = .; KEEP(*(SORT_BY_NAME(._net_socket_service_desc.static.*))); _net_socket_service_desc_list_end = .;; }
 ...
 settings_handler_static_area : { _settings_handler_static_list_start = .; KEEP(*(SORT_BY_NAME(._settings_handler_static.static.*))); _settings_handler_static_list_end = .;; }
...
datas :
{
 ...
 net_if_area : { _net_if_list_start = .; KEEP(*(SORT_BY_NAME(._net_if.static.*))); _net_if_list_end = .;; } net_if_dev_area : { _net_if_dev_list_start = .; KEEP(*(SORT_BY_NAME(._net_if_dev.static.*))); _net_if_dev_list_end = .;; } net_l2_area : { _net_l2_list_start = .; KEEP(*(SORT_BY_NAME(._net_l2.static.*))); _net_l2_list_end = .;; } eth_bridge_area : { _eth_bridge_list_start = .; KEEP(*(SORT_BY_NAME(._eth_bridge.static.*))); _eth_bridge_list_end = .;; }
...
fake_sensor_entry_area : { _fake_sensor_entry_list_start = .; KEEP(*(SORT_BY_NAME(._fake_sensor_entry.static.*))); _fake_sensor_entry_list_end = .;; }
http_resource_desc_dashboard_svc_area : { _http_resource_desc_dashboard_svc_list_start = .; KEEP(*(SORT_BY_NAME(._http_resource_desc_dashboard_svc.static.*))); _http_resource_desc_dashboard_svc_list_end = .;; }
remote_transport_area : { _remote_transport_list_start = .; KEEP(*(SORT_BY_NAME(._remote_transport.static.*))); _remote_transport_list_end = .;; }
http_header_name_area : { _http_header_name_list_start = .; KEEP(*(SORT_BY_NAME(._http_header_name.static.*))); _http_header_name_list_end = .;; }
} INSERT AFTER .data;
SECTIONS
{
 .native_sim_if.data :
